  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-24">
      ...
      <header className="mb-12 sm:mb-16">
        ...
        <p className="text-base sm:text-lg text-black/60 dark:text-white/60 leading-relaxed mb-6 sm:mb-8 max-w-3xl">
      ...
      <section className="mb-16 sm:mb-20">
        <h2 className="text-2xl md:text-3xl font-medium text-black dark:text-white mb-6 sm:mb-8">
          服务范围
        </h2>
      ...
      <section className="mb-16 sm:mb-20">
        ...
        <div className="space-y-6 text-base text-black/60 dark:text-white/60 leading-relaxed">
          ...
          <p>
            开发过程中我会给你看进度，有问题及时沟通调整。但项目完成验收后，只包含 <strong className="text-black dark:text-white">3 次免费修改</strong>的机会（修复 bug 不算）。如果需要大改功能或设计，需要另外商量。
          </p>
          <p>
            开始前我们会把需求和功能列清楚，避免后期扯皮。做什么、不做什么，一开始就说明白。
          </p>
          <p>
